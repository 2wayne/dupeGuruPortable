...
user in an INI file next to dupeGuruPortable.exe called dupeGuruPortable.ini.
...
copy AppNamePortable.ini from this directory to dupeGuruPortable.ini next to
dupeGuruPortable.exe. The options in the INI file are as follows:
